...
def _structural_fragment_gap_bridges(
    ...
    *,
    ...
    for idx, a in enumerate(segments):
        ...
        a_interval = sorted([(_project(a_coords[0]), a_coords[0]), (_project(a_coords[-1]), a_coords[-1])])
...
def _try_structural_open_loop(
    ...
    if _uses_jsx_structural_helpers(layer_name):
        ...
        helper_lines = _merge_line_strings([*helper_lines, *_structural_fragment_gap_bridges(helper_lines)])
