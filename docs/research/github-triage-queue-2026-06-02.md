...
- Pushed head: `970042a2c4bec5b17b198f57d97c36717fdb011d`
...
- `.venv/bin/python -m pytest -q` -> `655 passed, 7 skipped, 1 xfailed`
...
- `.venv/bin/python -m pytest webapp/tests -q` -> `43 passed`
...
- #1, #2, #3, #4: user-side validation, posting, customer discovery, and legal
  licensing decisions.
- #20 and #23: deferred product/engineering work; related PRs #38 and #39 remain
  separate from the verification-core cleanup.
...
- PR #34 and PR #41: keep open unless a human decides the research/control-plan
  artifacts are obsolete or superseded.
...
Verified locally:
- root pytest: 655 passed, 7 skipped, 1 xfailed
- ruff check: pass
- ruff format check: pass
- mkdocs build: pass
- webapp tests: 43 passed
- frontend check/build: pass

Superseded PRs to close against this stack: #36, #40, #42, #43, #44, #45.
